...
@NgModule({
    imports: [
        RouterModule.forRoot([
            ...
            {path: 'administration', component: AppLayoutComponent,loadChildren: () =>import('./demo/components/pages/pages.module').then(m => m.PagesModule)},
            {path: 'inventory', component: AppLayoutComponent,loadChildren: () =>import('./demo/components/productos/productos.module').then(m => m.ProductosModule)},
