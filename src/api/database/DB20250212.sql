...
INSERT INTO `tborders` VALUES (1,1,1,1,150.000,1,4,'2025-02-10'),(2,2,2,2,200.000,1,2,'2025-02-12');
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_tbordersproducts` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_tbordersproducts`(
	IN p_intClient int,
	IN p_intOrder int
)
BEGIN
...
BEGIN
    ...
    FROM tbOrders o
    INNER JOIN tbClients c ON c.intClient = o.intClient
    LEFT JOIN tbPaymentsMethod p ON p.intPayment =c.intPayment
    LEFT JOIN tbStatusOrders so ON so.intStatusOrder = o.intStatusOrder 
    LEFT JOIN tbCity ci ON ci.intCity = c.intCity
    INNER JOIN tbProducts pro ON pro.idProduct = o.intProducts;
...
-- Dump completed on 2025-02-12 18:02:50
